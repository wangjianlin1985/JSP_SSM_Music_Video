      ...
      <section class="m-b-lg">
        ...
        <form action="<%=basePath%>register.html" method="post">
          <div class="form-group">
            <input placeholder="用户名 4~16位" class="form-control rounded input-lg text-center no-border" name="userName" id="userName">
            <span id="cheName"></span>
          </div>
          <div class="form-group">
            <input type="email" placeholder="邮件" class="form-control rounded input-lg text-center no-border" name="userEmail">
          </div>
          <div class="form-group">
             <input type="password" placeholder="密码" class="form-control rounded input-lg text-center no-border" name="userPwd" id="userPwd">
              <span id="checkpwd"></span>
          </div>
          <div class="form-group">
             <input type="password" placeholder="重复密码" class="form-control rounded input-lg text-center no-border"
          ...
          <a href="login.html" class="btn btn-lg btn-info btn-block btn-rounded">登录</a>
        </form>
      </section>
    </div>
  </section>
