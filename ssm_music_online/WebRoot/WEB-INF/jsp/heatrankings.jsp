	...
	<section class="vbox">
		<header
			...
			<form
				...
				<span>&emsp;</span>
					<a target="_blank" href="AdminLogin.html" ><span class="glyphicon glyphicon-new-window"></span>&nbsp;管理员登录</a>
			</div>
		</header>
		<section>
					...
					<section class="vbox">
						<section class="w-f-md">
							<section class="hbox stretch bg-black dker">
								...
								<aside class="col-sm-12 no-padder" id="sidebar">
...
<!-- 												<img class="img" src="images/m43.jpg" alt="..." style="height="500px";> -->
											</div>
												...
												<c:if test="${not empty data}">
													<c:forEach items="${data}" var="Json" varStatus="st">
														<li class="list-group-item text-center">
															<a href="#"
															class="jp-play-me m-r-sm pull-left myplay json"
                    ...
                    <div class="m-t-n-xxs">
                      ...
                      <div class="item pos-rlt">
                        <a href="MusicTop10.html" class="item-overlay active opacity wrapper-md font-xs">
                          ...
                          <span class="text-muted">Guide Musin hot 10</span>
                          <span class="bottom wrapper-md block">- <i class="icon-arrow-right i-lg pull-right"></i></span>
                        </a>
