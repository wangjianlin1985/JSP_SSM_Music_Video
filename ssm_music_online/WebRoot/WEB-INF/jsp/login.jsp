...
<!--           <strong>Sign in to get in touch</strong> -->
        ...
        <form action="chelogin.html" method="post">
          <div class="form-group">
            <input type="text" placeholder="用户名" class="form-control rounded input-lg text-center no-border" name="UserName">
          </div>
          <div class="form-group">
          ...
          <div class="text-center m-t m-b"><a href="signup.html"><small>忘记密码?</small></a></div>
